...
const DATA = [
           ...
           {title: "Самостоятеьность", description: "Способность выполнять работу с минимальным контролем со стороны руководителя, стремление к изучению смежных областей системы и работы других групп"},
